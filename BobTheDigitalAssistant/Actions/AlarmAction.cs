...
namespace BobTheDigitalAssistant.Actions
{
	public class AlarmAction : Action
	{
		...
		public override void PerformAction()
		{
			...
			switch (desiredAction)
			{
				case AlarmActionTypes.CREATE:
					...
					if (this.DynamicArea != null && alarm != null)
					{
						RelativePanel panel = this.CreateAlarmCard(alarm);
		...
		{
			Alarm alarmToDelete = this.GetAlarmForClosestMatchToPassedDate();
			if (alarmToDelete != null)
			{
				...
				this.ShowMessage($"Successfully deleted alarm {alarmToDelete.Title}");
			}
			else
			{
				this.ClearArea();
		...
		private DateTime? GetAlarmDateAndTime()
		{
